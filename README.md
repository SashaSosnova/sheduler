...
1. Удали старое Kanikuly / Sheduler из списка приложений (иначе старая подпись может мешать).
...
- **Прогресс** — уровень, звёзды и серия идеальных дней (только у ребёнка)
