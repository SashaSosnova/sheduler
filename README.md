...
1. Автоблокировка → выкл.
2. Play Protect → выключи проверку приложений.
3. Удали все старые «Каникулы».
4. Лучше скачать APK на компьютер и перекинуть на телефон через USB / Диск / Telegram (не открывать из браузера GitHub).
